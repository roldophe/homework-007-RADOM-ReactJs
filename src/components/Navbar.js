...
/* <div class="container mx-auto pl-3" >
                <div class="relative flex h-16 items-center justify-between dark:text-white">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <button
                            type="button"
                            class="black  hover:text-blue-900 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 mr-2 mb-2 dark: focus:outline-none dark:focus:ring-blue-800"
                            onClick={() => navigate("/create")}
                        >
                            Insert
                        </button>
