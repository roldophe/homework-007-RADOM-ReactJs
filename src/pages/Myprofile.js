                    ...
                    isLogin ?
                        ...
                        <div class="flex flex-col h-screen bg-center bg-cover bg-no-repeat bg-gray-100">
                            <div
                                ...
                                <h1 class="text-4xl font-bold uppercase text-indigo-600 transition duration-500">Please login</h1>
                                <h2 class="text-xl text-gray-700 transition duration-500">
                                    Login to Access Your Account and Enjoy Convenient Social Login Options
                                </h2>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <a href="/login" title="Quicktoolz On Facebook"
